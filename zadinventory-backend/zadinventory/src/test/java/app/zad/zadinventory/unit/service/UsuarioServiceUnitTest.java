...
class UsuarioServiceUnitTest {
    ...
    // Sem este mock o @InjectMocks injeta null e salvar()/atualizar() estouram NullPointerException.
    @Mock
    ...
    void deveAtualizarUsuarioComDadosValidos() {
        ...
        // A senha nunca pode ser gravada em texto puro: o service passa pelo PasswordEncoder.
