...
public class UsuarioService {
    ...
    public UsuarioEntity salvar(UsuarioEntity usuario) {
        ...
        // O email precisa ser gravado normalizado: buscarPorEmail() consulta sempre
        // em minusculas, entao gravar "Joao@Email.com" tornaria o login impossivel.
    ...
    private void validarUsuario(UsuarioEntity usuario) {
        ...
        if (repository.existsByEmail(usuario.getEmail().trim().toLowerCase())) {
